      ...
      <div className="container">
        <div className={styles.headerGrid}>
          <div className={styles.headerColumn}>
            ...
            <a href="/starter" className="no-decoration" style={{ textDecoration: 'none' , color: 'black'}}>Fußball.de Tabellen </a>
...
function Form() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const rawResponse = await fetch("http://localhost:3001/newAPI", {
        method: "POST",
        headers: {
      ...
      if (content.success == true) {
        var url = "http://localhost:3001/" + key + "/" + website;
        setResult(url);
      } else {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.column}>
          <p className={styles.textWrapper}>
            ...
            <code>DOMAIN/schlüssel/webseite</code>. Durch den Tag <i>show</i>{" "}
            kannst du die Tabelle direkt im Browser anschauen{" "}
            <code>
              DOMAIN/<b>show</b>/schlüssel/webseite
            </code>
            .
          </p>
        </div>
